...
const modalViews = document.querySelectorAll('.work__modal')
      modalBtns = document.querySelectorAll('.work__link')
...
if (selectedTheme) {
    // If the validation is fulfilled, we ask what the issue was to know if we activated or deactivated the light mode
...
themeButton.addEventListener('click', () => {
    ...
    // We save the theme and the current icon the user chooses
